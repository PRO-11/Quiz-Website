      ...
      <div className="card-body ">
        ...
        <div className="row">
          ...
          <div className="col-6 col-md-6 my-2">Time Limit: {end} Minutes</div>
           ...
           {(enablebt==1)?<Link className="col-md-3 my-2 "  to={{
            pathname: "/user/startquiz",
            state: { quiz_id, quiz, start, end }
          }}  style={{"border": "2px solid black","background": "red","color":"cornsilk","borderRadius": "3px","textDecoration":"none"}}>Start Quiz</Link>:<Link className=" col-md-3 my-2 disabledCursor" to="#" onClick={(event) => event.preventDefault()}  style={{"border": "2px solid black","background": "red","color":"grey","borderRadius": "3px","textDecoration":"none"}}>Start Quiz</Link>}
           </div>
      </div>
