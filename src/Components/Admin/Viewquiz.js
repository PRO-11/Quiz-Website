...
function Viewquiz(props) {
    ...
    const getallQues = async () => {
        const response = await fetch("http://localhost:5000/admin/viewquiz", {
            method: 'POST',
            headers: {
    ...
    const updatedate=async()=>{
        ...
        if(!start.start.includes(":00.000Z"))
           ...
           const response = await fetch("http://localhost:5000/admin/updatedate", {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'auth-token': localStorage.getItem('adtoken')
    ...
    const handleClick = async (e) => {
        ...
        const response = await fetch("http://localhost:5000/admin/updateques", {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'auth-token': localStorage.getItem('adtoken')
